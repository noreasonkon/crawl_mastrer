...
from trade.items import BigpsDailyfutureItem


class BigpsDailyfutureSpider(scrapy.Spider):
    name = 'bigps_dailyfuture'
    ...
    def transform_data(self, response):
        ...
        df.columns = ['date','commodity', 'commodity_cn','contract', 
